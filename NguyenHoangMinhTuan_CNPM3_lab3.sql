...
-----Câu 8: Hiển thị Danh sách sinh viên học lớp AV1 và sinh sau ngày 1/1/1980
SELECT * 
FROM Students 
WHERE Class = 'AV1' AND DateofBirth > '1980/1/1';
-----Câu 9: Xoá sinh viên có mã AV0807011
DELETE 
FROM Students 
WHERE StudentID = 'AV0807011';
-----Câu 10: Hiển thị danh sách sinh viên dự thi môn có mã S001 ngày 6/5/2008 bao gồm các trường sau: StudentID, StudentName, SubjectName, Theory, Practical,Date
